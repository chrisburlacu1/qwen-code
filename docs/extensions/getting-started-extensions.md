...
2.  **Build the server:**
    ...
    This will compile `example.ts` into `dist/example.js`, which is the file referenced in your `sosh-extension.json`.
...
2.  Update your `sosh-extension.json` to tell the CLI to load this file:
